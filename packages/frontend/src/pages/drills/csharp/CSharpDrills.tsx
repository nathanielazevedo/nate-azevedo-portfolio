...
import DrillSideNav from "../python/DrillSideNav";
...
import arraysQuestions from "./questions/arrays.json";
import listsQuestions from "./questions/lists.json";
import dictionariesQuestions from "./questions/dictionaries.json";
import linqQuestions from "./questions/linq.json";
import methodsQuestions from "./questions/methods.json";
...
const BROKEN_QUESTIONS_KEY = "csharp-drills-broken-questions";
const PROGRESS_KEY = "csharp-drills-progress";
  ...
  return (
    <Box sx={{ py: 1, bgcolor: "background.default" }}>
      <Container maxWidth="xl">
        ...
        >
          <Typography variant="h6">C# Drills</Typography>
        </Box>
